...
export const dataOfCountry = {}
dataOfCountry.country = []
dataOfCountry.capital = []
dataOfCountry.population = []
dataOfCountry.language = []

for (const iterator of dataOfCountryCap) {
    if(iterator.city == null){
        iterator.city = 'Unknown'
    }
