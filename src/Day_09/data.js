...
export const objectOfCountries = [
    {
        "alpha_2": "AD",
        "alpha_3": "AND",
        "area": "468",
 ...
 for (const i of objectOfCountries) {
    if (i.capital == ""||i.capital == " "||i.capital == ''||i.capital == ' ') {
        i.capital = "Unknown"
        
    }else if(i.capital== " Willemstad"){
        i.capital = "Willemstad"
 ...
 objectOfCountries[8].languages = "Unknown"
 objectOfCountries[33].languages = "Unknown"
 objectOfCountries[95].languages = "Unknown"